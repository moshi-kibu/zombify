...
human_messages = [
	...
	["You Must Go...","We need at least 10 humans to travel to #{locations[0]}, to harvest a cure ingredient, #{cure_ingredients[0]}. When you arrive, please harvest the ingredient (check in at the location), then run. Zombies tend to gather where cure ingredients can be found."],
	["Another Ingredient!","We need at least 10 humans to travel to #{locations[1]}, to harvest a cure ingredient, #{cure_ingredients[1]}. When you arrive, please harvest the ingredient (check in at the location), then run!"],
	["It Is Time!","We need at least 10 humans to travel to #{locations[2]}, to harvest a cure ingredient, #{cure_ingredients[2]}. When you arrive, please harvest the ingredient (check in at the location), then run. The Zombie threat is always present."],
	["Attention Survivors!","We need at least 10 humans to travel to #{locations[3]}, to harvest a cure ingredient, #{cure_ingredients[3]}. When you arrive, please harvest the ingredient (check in at the location), then run. As you know, Zombies tend to gather where cure ingredients can be found."],
	["Attention Survivors!","We need at least 10 humans to travel to #{locations[4]}, to harvest a cure ingredient, #{cure_ingredients[4]}. When you arrive, please harvest the ingredient (check in at the location), then run!"],
